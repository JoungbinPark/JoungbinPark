...
public class Application {
    public static void main(String[] args){
        /* 객체지향 프로그래밍에 대해 이해하고 객체와 클래스를 설계하여 프로그래밍을 할 수 있다. */
        /* 객체 지향 프로그래밍이란
        ...
        /*
        * 객체를 설계하기 위해서는 복잡한 현실세계를 그대로 반영하기엔 너무 방대하고 복잡하기 때문에
        * 현실세계를 프로그램의 목적에 맞게 단순화하는 추상화라는 기법을 적용하게 된다. */

        /* 추상화란?
        * 공통된 부분을 추출하고 공통되지 않은 부분을 제거한다는 의미를 가지며
        * 추상화의 목적은 유연성을 확보하기 위함이다.
        * 유연성 확보는 여러 곳에 적용할 수 있는 유일한 객체를 의미하며, 재사용성이 높아질 수 있다는 의미다.
